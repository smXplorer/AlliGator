...
<Library LVVersion="21008000">
	...
	<Item Name="Resize Button to Fit Text.vi" Type="VI" URL="../Resize Button to Fit Text.vi"/>
	<Item Name="ROI Peak Button.ctl" Type="VI" URL="../ROI Peak Button.ctl"/>
	<Item Name="Scale Bar.ctl" Type="VI" URL="../Scale Bar.ctl"/>
</Library>
