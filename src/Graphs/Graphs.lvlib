...
<Library LVVersion="21008000">
	...
	<Item Name="Get Plot at Mouse Click [AC].vi" Type="VI" URL="../Get Plot at Mouse Click (XY Graph)/Get Plot at Mouse Click [AC].vi"/>
	<Item Name="Get Plot at Mouse Click [ACCA].vi" Type="VI" URL="../Get Plot at Mouse Click (XY Graph)/Get Plot at Mouse Click [ACCA].vi"/>
	<Item Name="Get Plot at Mouse Click [APAC].vi" Type="VI" URL="../Get Plot at Mouse Click (XY Graph)/Get Plot at Mouse Click [APAC].vi"/>
	<Item Name="Get Plot at Mouse Click [CA].vi" Type="VI" URL="../Get Plot at Mouse Click (XY Graph)/Get Plot at Mouse Click [CA].vi"/>
	<Item Name="Get Plot at Mouse Click [PA].vi" Type="VI" URL="../Get Plot at Mouse Click (XY Graph)/Get Plot at Mouse Click [PA].vi"/>
	<Item Name="Get Plot at Mouse Click in Legend.vi" Type="VI" URL="../Get Plot at Mouse Click (XY Graph)/Get Plot at Mouse Click in Legend.vi"/>
	<Item Name="Get Plot at Mouse Click in Plot Area [AAC].vi" Type="VI" URL="../Get Plot at Mouse Click (XY Graph)/Get Plot at Mouse Click in Plot Area [AAC].vi"/>
	<Item Name="Get Plot at Mouse Click in Plot Area [AC].vi" Type="VI" URL="../Get Plot at Mouse Click (XY Graph)/Get Plot at Mouse Click in Plot Area [AC].vi"/>
	<Item Name="Get Plot at Mouse Click in Plot Area [ACCA].vi" Type="VI" URL="../Get Plot at Mouse Click (XY Graph)/Get Plot at Mouse Click in Plot Area [ACCA].vi"/>
	<Item Name="Get Plot at Mouse Click in Plot Area [APAC].vi" Type="VI" URL="../Get Plot at Mouse Click (XY Graph)/Get Plot at Mouse Click in Plot Area [APAC].vi"/>
	<Item Name="Get Plot at Mouse Click in Plot Area [CA].vi" Type="VI" URL="../Get Plot at Mouse Click (XY Graph)/Get Plot at Mouse Click in Plot Area [CA].vi"/>
	<Item Name="Get Plot at Mouse Click in Plot Area [PA].vi" Type="VI" URL="../Get Plot at Mouse Click (XY Graph)/Get Plot at Mouse Click in Plot Area [PA].vi"/>
