...
<Library LVVersion="21008000">
	...
	<Item Name="Convert Date to Timestamp.vi" Type="VI" URL="../Convert Date to Timestamp.vi"/>
	<Item Name="High Resolution Timing.vi" Type="VI" URL="../High Resolution Timing.vi"/>
	<Item Name="PicoStart Date.ctl" Type="VI" URL="../PicoStart Date.ctl"/>
</Library>
