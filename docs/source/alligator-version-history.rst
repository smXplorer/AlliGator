...
-----------------
    ...
    - New Features
        ...
        + Now checking that loaded references have been defined with the same phasor frequency as tModified Phasor Ratio calculation (at Mouse Location) to actually perform this task (not using the last computed phasor)
