...
<Library LVVersion="21008000">
	...
	<Item Name="Is Infinite.vim" Type="VI" URL="../Is Infinite.vim"/>
	<Item Name="Is Valid Number (SGL 2D Array).vi" Type="VI" URL="../Is Valid Number (SGL 2D Array).vi"/>
	<Item Name="Is Valid Number (SGL Array).vi" Type="VI" URL="../Is Valid Number (SGL Array).vi"/>
	<Item Name="x = y (+-epsilon) [DBL].vi" Type="VI" URL="../x = y (+-epsilon) [DBL].vi"/>
