...
<Library LVVersion="21008000">
	...
	<Item Name="Download Web File.vi" Type="VI" URL="../Download Web File.vi"/>
	<Item Name="Get Redirection URL (HTTP 302).vi" Type="VI" URL="../Get Redirection URL (HTTP 302).vi"/>
	<Item Name="Get Redirection URL.vi" Type="VI" URL="../Get Redirection URL.vi"/>
</Library>
