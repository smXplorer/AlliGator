...
AlliGator Python Plugins API v 1.1
++++++++++++++++++++++++++++++++++

AlliGator versions: 1.07-current
...
The different data types are declared in the ``alligatorFLI_1_1.py`` script 
found in the *Python Plugins* folder, reproduced below:
...
.. code-block::
  ...
  ############################################################################
  # Graph: contains several plots (not necessarily all plots)
  ############################################################################
  ...
  # 'IRF_Y_Flattened_List' is a list of IRF Intensities at the different 
  # locations
...
The different data types are declared in the ``alligator.py`` script found in 
the *Python Plugins* folder, reproduced below:
